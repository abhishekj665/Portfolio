...
import { profile_data, project_data } from "../project_data";
...
const Projects = () => {
  return (
    <main
      ...
      id="projects"
    >
      <section className="flex items-center gap-4 pt-2 reveal-motion">
        <hr className="h-1 w-12 bg-gray-600 rounded-full" />
        <p className="text-2xl font-semibold section-heading-gradient">
          Featured Projects
        </p>
      </section>
          ...
          >
            ...
            <section className="p-1 lg:w-1/2 max-w-fit flex items-center">
              <Image
                ...
                alt={`${e.title} by ${profile_data.name}`}
                priority={false}
                height={300}
                width={600}
                style={{
            ...
            <section className="p-1 lg:p-2 gap-1 flex flex-col lg:w-2/3 max-w-fit">
              ...
              {/* Project Description */}
              <p className="lg:text-lg text-black lg:p-2 leading-relaxed">
                {e.description}
              </p>
              {/* Project Buttons */}
              <section className="lg:p-2 flex justify-end gap-4 max-lg:p-3">
                ...
                >
                  ...
                  <span className="text-slate-800 text-sm pt-1.5 flex items-center font-medium">
